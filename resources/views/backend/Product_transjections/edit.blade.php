            ...
            <div class="card-body">
                ...
                <form action="{{ route(' product_transjection.update',$ Product_transjection->id)}}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="store_id" class="form-control" id="inputTitle" value="{{$ product_transjection->store_id ?? ''}}">
                            @error('store_id')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="rack_id" class="form-control" id="inputTitle" value="{{$ product_transjection->rack_id ?? ''}}">
                            @error('rack_id')
                                <div class="text-danger mt-3">{{$message}} </div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="box_id" class="form-control" id="inputTitle" value="{{$ product_transjection->box_id ?? ''}}">
                            @error('box_id')
                                <div class="text-danger mt-3">{{$message}} </div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="product_id" class="form-control" id="inputTitle" value="{{$ product_transjection->product_id ?? ''}}">
                            @error('product_id')
                                <div class="text-danger mt-3">{{$message}} </div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="qty" class="form-control" id="inputTitle" value="{{$ product_transjection->qty ?? ''}}">
                            @error('qty')
                                <div class="text-danger mt-3">{{$message}} </div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="status" class="form-control" id="inputTitle" value="{{$ product_transjection->status ?? ''}}">
                            @error('status')
                                <div class="text-danger mt-3">{{$message}} </div>
                            @enderror
                        </div>
