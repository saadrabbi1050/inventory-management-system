...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" data-bs-target="#forms-supplier2" data-bs-toggle="collapse" href="#">
      <i class="bi bi-journal-text"></i><span>Product Order</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
    <ul id="forms-supplier2" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      <li>
        <a  href="{{route('product_order.create')}}">
          <i class="bi bi-circle"></i><span>Create</span>
        </a>
      </li>
      <li>
